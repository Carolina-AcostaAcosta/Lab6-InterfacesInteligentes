...
# Laboratorio 6 - XR Interaction Toolkit

Para el desarrollo de esta práctica se ha realizado todo en una única escena, con los scripts agregados al repo.

1. Instalar XR Interaction Toolkit y Meta XR.
2. Activar OpenXR + Meta en el proyecto.
3. Configurar el XR Simulator (Meta).
